...
Thank you for your interest in contributing to K8s Namespace Sync!
...
```bash
git commit -m "feat: add support for label filtering"
```
...
Open an [issue](https://github.com/somaz94/k8s-namespace-sync/issues) for questions or discussion.
