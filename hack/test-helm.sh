...
# ── Test: Event Recording via Helm ──
echo ""
log_info "[Test] Event Recording"
...
# ── Test: Status Conditions via Helm ──
echo ""
log_info "[Test] Status Conditions"
...
# ── Test: Sync Metadata Annotations via Helm ──
echo ""
log_info "[Test] Sync Metadata Annotations"
